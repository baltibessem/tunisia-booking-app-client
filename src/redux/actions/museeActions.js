...
// export const getAllMusees = () => dispatch => {

//     dispatch({ type: 'GET_MUSEES_REQUEST' })

//     axios.get('/api/museespage/allmusees').then(res => {
//         console.log(res);

//         dispatch({ type: 'GET_MUSEES_SUCCESS', payload: res.data })
//     }).catch(err => {
//         console.log(err);
